...
import jwtc.android.chess.MyPGNProviderARM;
                        ...
                        if (engines.size() > 0) {
                            ...
                            builder.setPositiveButton(getString(R.string.button_ok), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    pgntool.this.getContentResolver().delete(MyPGNProviderARM.CONTENT_URI, "1=1", null);
    ...
    public void doExport() {
        try {
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                int i = 0;
                Cursor cursor = managedQuery(MyPGNProviderARM.CONTENT_URI, PGNColumns.COLUMNS, null, null, PGNColumns.DEFAULT_SORT_ORDER);
                if (cursor != null) {
