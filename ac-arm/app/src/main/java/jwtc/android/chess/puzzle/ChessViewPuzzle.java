...
public class ChessViewPuzzle extends UI {
    ...
    public void getNumPuzzles() {
        ...
        _cursor = _parent.managedQuery(MyPuzzleProviderARM.CONTENT_URI_PUZZLES, MyPuzzleProviderARM.COLUMNS, null, null, "");
        ...
        //Cursor countCursor = _cr.query(MyPuzzleProviderARM.CONTENT_URI_PUZZLES, new String[] {"count(*) AS count"}, null, null, null);
...
/*
    ...
    public void play() {
        ...
        if (_cursor != null) {
            ...
            sPGN = _cursor.getString(_cursor.getColumnIndex(MyPuzzleProviderARM.COL_PGN));
